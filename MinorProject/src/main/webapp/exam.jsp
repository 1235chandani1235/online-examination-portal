...
<div class="sidebar">
	...
	<div class="sidebar-background">
		...
		<div class="left-menu">
			<a href="std-page.jsp?pgprt=0"><h2>Profile</h2></a> <a class="active"
				href="std-page.jsp?pgprt=1"><h2>Exams</h2></a> <a
...
<!--prevention to switch the windows-->
<script>
			...
			.addEventListener(
					...
					function(event) {
						if (event.ctrlKey || event.metaKey) {
							event.preventDefault();
							alert("Opening links in new tabs/windows is not allowed during the test.");
						}
					});

	window.addEventListener('blur', function() {
		alert('Please do not switch tabs or windows during the test.');
...
<div class="content-area">
	...
	<form id="myform" action="controller.jsp">
		...
		<center>
			...
			<input type="hidden" name="page" value="exams"> <input
				type="hidden" name="operation" value="submitted"> <input
				type="submit" class="add-btn" value="Done">
	</form>
	<%
	}
	...
	<div class="panel" style="float: left; max-width: 900px">
		...
		<div class="profile">
			...
			<span class="tag">Result</span><span class="val"><%=result.getStatus()%></span><br />
			<!-- span class="tag">percentage marks</spanspan class="valresult.getObtMarks()/result.gettMarks())*100%>)</span><br />-->

		
			<!--  --c:out value="${result.getStatus()}" />-->
	...
	<div class="panel form-style-6"
		style="float: left; max-width: 900px; padding-top: 40px;">
		<div class="title" style="margin-top: -60px;">Select Course to
			Take Exam</div>
		<br />
		...
		<form action="controller.jsp">
			<br /> <br> <label>Select Course</label> <input type="hidden"
				...
				%>
			</select> <input type="submit" value="Take Exam" class="form-button">
		</form>
